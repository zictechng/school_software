...
function ViewComments(props) {
    document.title = "View Comment Details | " + window.companyName;
                    ...
                    <div className="row mb-2">
                        ...
                        <div className="col-sm-6">
                            <ol className="breadcrumb float-sm-right">
                                <li className='mr-3'>
                                    <Link to='/staff/comment'><button type="button" className="btn btn-block btn-dark btn-sm" data-tip="Back" data-place="bottom"><i className='fa fa-arrow-left'> Back</i> </button>
                                    </Link>
                                </li>
                                <li className='mr-3'>
                                        ...
                                        <div className="row no-print">
                                            <div className="col-12">
                                                <ReactToPrint
                                                    ...
                                                    documentTile="Student comment details"
                                                />
                ...
                <form>
                    <Modal.Body>
                        ...
                        <div className="row">
                            <div className="col-sm-9">
                                <div className="form-group">
                                    ...
                                    <input type="text" name="comm_stu_number" readOnly value={subjectInputs.comm_stu_number} className="form-control" placeholder="Admin Number" />
                        ...
                        <div className="row">
                            ...
                            <input type="hidden" readOnly name='id' value={subjectInputs.id} onChange={handleEdit} className="form-control" placeholder="ID" />
                        </div>
                        {id}
                    </Modal.Body>
                    <Modal.Footer>
